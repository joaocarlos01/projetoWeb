	...
	<div class="wrapper">
		...
		<form action="" method="POST" class="form">
			...
			<div class="input-group textarea">
				...
				<textarea id="texto" name="texto" placeholder="Escreva o Comentário" ></textarea>
			</div>
			<div>
			<?php
if (isset($_POST['submit'])) { 
	...
	if($comment != null){
		...
		if ($result ) {
			echo "<a>Comentário adicionado!</a>";
			} 	
		else {
			echo "<a>Já comentou!</a>";
			}
	}
	else{
		echo "<a>Escreva Algo!</a>";
	}
...
if (isset($_POST['delete'])) { 
	...
	$sql = "DELETE FROM comentario WHERE email='{$email}'";
	$result = mysqli_query($conexao, $sql);
    
    
    
    if ($result) {
		echo "<a>Comentário Apagado!</a>";
	} 
}
			...
			<div class="input-group">
				...
				<button name="delete" class="btn">Apagar</button>
			</div>
		</form>
